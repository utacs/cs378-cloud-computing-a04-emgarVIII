...
public class ErrorRatesRunner extends Configured implements Tool {
	...
	public int run(String args[]) {
		...
		// System.out.println("File: " + args[0] + ", output of Map-Reduce task: " + args[1] + ", output of topK task: " + args[2]);
			...
			Job job = new Job(conf, "ErrorRatesRunner");
			job.setJarByClass(ErrorRatesRunner.class);
			...
			System.out.println("Performing topk");
            
			Job job2 = new Job(conf, "TopK");
			job2.setJarByClass(ErrorRatesRunner.class);
