...
public class ErrorRates extends Configured implements Tool {
	...
	public int run(String args[]) {
		...
		// System.out.println("File: " + args[0] + ", output of Map-Reduce task: " + args[1] + ", output of topK task: " + args[2]);
			...
			Job job = new Job(conf, "ErrorRates");
			job.setJarByClass(ErrorRates.class);
			...
			job2.setJarByClass(ErrorRates.class);
